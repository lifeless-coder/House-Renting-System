...
if(isset($_POST['post'])){
   ...
   if(isset($_POST['gas_supply'])){
      $gas_supply = $_POST['gas_supply'];
      $gas_supply = filter_var($gas_supply, FILTER_SANITIZE_STRING);
   }else{
      $gas_supply = 'no';
   }
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="checkbox">
         <div class="box">
            ...
            <p><input type="checkbox" name="gas_supply" value="yes" />gas supply</p>
         </div>
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" />parking area</p>
            <p><input type="checkbox" name="gym" value="yes" />gym</p>
            <p><input type="checkbox" name="WiFi" value="yes" />24/7 WiFi</p>
